...
- [ ] T1 [R1, R2, P1, P2, P3] — `resolvePlayerOverlaps` in `src/shared/src/sim/collide.ts`
...
- [ ] T2 [R3, P1] — Solids win: re-resolve against arena geometry after separating
...
- [ ] T3 [R1] — Call it from the shell in `src/server/src/match.ts`, once
...
- [ ] T4 [R3] — `hot-potato`'s contact tolerance
