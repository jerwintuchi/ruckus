...
- [x] T1 [R1, R6] — The disc, in `src/client/src/ui/kit.ts`
...
- [x] T2 [R2, R7] — `deal` on arrival and `punch` on GO
...
- [x] T3 [R3] — The draining ring, reusing the cooldown construction
...
- [x] T5 [R5, P5] — It always leaves, by every path
...
- [x] T6 [R6, P1, P3] — Nothing happens on a frame where the digit has not changed
...
- [x] T7 [R4] — GO releases, and the arena is clear at the first playable instant
