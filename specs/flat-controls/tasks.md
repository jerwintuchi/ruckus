...
- [ ] T1 [R1, P2] — Take the shadow off every control in `src/client/src/ui/kit.ts` and
...
- [ ] T2 [R2, P1] — One press language: `PRESS_SCALE` plus an ink-soak fill, replacing
...
- [ ] T3 [R1] — Write the rule where it will be met: one line in
