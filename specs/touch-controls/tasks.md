...
- [ ] T1 [R3, P4] — Add `buttonLabel?: string` to `Minigame` in
...
- [ ] T2 [R3] — Carry the label on `roundStart`
...
- [ ] T3 [R1, R2, P1] — The stick in `src/client/src/ui/controls.ts`
...
- [ ] T4 [R4, R5, P2, P3] — The button, with an honest hit area
...
- [ ] T5 [R5] — `InputController` reads the button from the control, not from a screen
  ...
  (RD-029 holds); **no `innerWidth *` fraction remains in the touch source**, asserted
  against it, since that fraction is the invisible slab this task exists to remove

- [ ] T6 [R5] — Controls inside the safe area
